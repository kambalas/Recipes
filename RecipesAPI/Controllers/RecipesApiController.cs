    ...
    namespace IO.Swagger.Controllers
    {
        ...
        public class RecipesApiController : ControllerBase
        {
            ...
            {
			Console.WriteLine($"Received DTO: {JsonConvert.SerializeObject(recipeDTO)}");
			var recipe1 = _mappers.ToRecipe(recipeDTO);
			Console.WriteLine($"Mapped Entity: {JsonConvert.SerializeObject(recipe1)}");
