...
//
//     function appendSteps(steps, list) {
//         steps.forEach(step => {
...
//     }
//
//     appendSteps(prepSteps, prepList);
//     appendSteps(cookingSteps, cookingList);
// }
...
function loadSteps(steps) {
        ...
        return prepSteps.length === prepList.children.length && cookingSteps.length === cookingList.children.length;
